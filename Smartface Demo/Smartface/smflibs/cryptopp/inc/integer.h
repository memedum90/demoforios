	...
	//@{
		...
		void GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &params = g_nullNameValuePairs)
		{
			if (!GenerateRandomNoThrow(rng, params))
                ...
                splog(SPERR, "integer.h", "RandomNumberNotFound");
		}
...
//!
inline bool operator==(const SmfCryptoPP::Integer& a, const SmfCryptoPP::Integer& b) {return a.Compare(b)==0;}
//!
inline bool operator!=(const SmfCryptoPP::Integer& a, const SmfCryptoPP::Integer& b) {return a.Compare(b)!=0;}
//!
inline bool operator> (const SmfCryptoPP::Integer& a, const SmfCryptoPP::Integer& b) {return a.Compare(b)> 0;}
...
inline bool operator<=(const SmfCryptoPP::Integer& a, const SmfCryptoPP::Integer& b) {return a.Compare(b)<=0;}
//!
inline SmfCryptoPP::Integer operator+(const SmfCryptoPP::Integer &a, const SmfCryptoPP::Integer &b) {return a.Plus(b);}
//!
inline SmfCryptoPP::Integer operator-(const SmfCryptoPP::Integer &a, const SmfCryptoPP::Integer &b) {return a.Minus(b);}
//!
inline SmfCryptoPP::Integer operator*(const SmfCryptoPP::Integer &a, const SmfCryptoPP::Integer &b) {return a.Times(b);}
//!
inline SmfCryptoPP::Integer operator/(const SmfCryptoPP::Integer &a, const SmfCryptoPP::Integer &b) {return a.DividedBy(b);}
//!
inline SmfCryptoPP::Integer operator%(const SmfCryptoPP::Integer &a, const SmfCryptoPP::Integer &b) {return a.Modulo(b);}
//!
inline SmfCryptoPP::Integer operator/(const SmfCryptoPP::Integer &a, SmfCryptoPP::word b) {return a.DividedBy(b);}
//!
inline SmfCryptoPP::word    operator%(const SmfCryptoPP::Integer &a, SmfCryptoPP::word b) {return a.Modulo(b);}

NAMESPACE_END

#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
inline void swap(SmfCryptoPP::Integer &a, SmfCryptoPP::Integer &b)
{
	a.swap(b);
}
NAMESPACE_END
