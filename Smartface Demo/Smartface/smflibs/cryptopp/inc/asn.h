...
inline void BERDecodeError() {
    //throw BERDecodeErr();
    splog(SPERR, "asn.h", "BERDecodeErr");
}
...
inline bool operator==(const ::SmfCryptoPP::OID &lhs, const ::SmfCryptoPP::OID &rhs)
	{return lhs.m_values == rhs.m_values;}
inline bool operator!=(const ::SmfCryptoPP::OID &lhs, const ::SmfCryptoPP::OID &rhs)
	{return lhs.m_values != rhs.m_values;}
inline bool operator<(const ::SmfCryptoPP::OID &lhs, const ::SmfCryptoPP::OID &rhs)
	{return std::lexicographical_compare(lhs.m_values.begin(), lhs.m_values.end(), rhs.m_values.begin(), rhs.m_values.end());}
inline ::SmfCryptoPP::OID operator+(const ::SmfCryptoPP::OID &lhs, unsigned long rhs)
	{return ::SmfCryptoPP::OID(lhs)+=rhs;}
