...
*/
	...
	void GetRequiredParameter(const char *className, const char *name, T &value) const
	{
		if (!GetValue(name, value)) {
			splog(SPERR,"cryptlib.GetRequiredParameter",": missing required parameter '%s'",name);
	...
	CRYPTOPP_DLL void GetRequiredIntParameter(const char *className, const char *name, int &value) const
	{
		if (!GetIntValue(name, value)) {
			splog(SPERR,"cryptlib.GetRequiredParameter",":2 missing required parameter '%s'", name);
			//throw InvalidArgument(std::string(className) + ": missing required parameter '" + name + "'");
		}
	}
...
public:
	...
	virtual Clonable* Clone() const {
		splog(SPERR,"cryptlib.Clonable","Clone() is not implemented yet.");
...
public:
	...
	virtual unsigned int IVSize() const {
		splog(SPERR,"cryptlib.IVSize"," this object doesn't support resynchronization =%s",GetAlgorithm().AlgorithmName().c_str());
	...
	virtual void Resynchronize(const byte *iv, int ivLength=-1) {
		splog(SPERR,"cryptlib.Resynchronize"," this object doesn't support resynchronization =%s",GetAlgorithm().AlgorithmName().c_str());
		//throw NotImplemented(GetAlgorithm().AlgorithmName() + ": this object doesn't support resynchronization");
	}
...
public:
	...
	virtual void Seek(lword n)
	{
		...
		splog(SPERR,"crptlib.Seek","StreamTransformation: this object doesn't support random access");
...
public:
	...
	virtual void IncorporateEntropy(const byte *input, size_t length) {
		splog(SPERR,"crytlib.IncorporateEntropy","RandomNumberGenerator: IncorporateEntropy not implemented");
...
public:
	...
	//@{
		virtual void IsolatedInitialize(const NameValuePairs &parameters) {
			splog(SPERR,"crytlib.IsolatedInitialize","BufferedTransformation: this object can't be reinitialized");
	...
	*/
	//@{
		...
		virtual void Detach(BufferedTransformation *newAttachment = 0)
			{assert(!Attachable());
			splog(SPERR,"crptlib.Detach","BufferedTransformation: this object is not attachable");
...
public:
	...
	virtual void ThrowIfInvalid(RandomNumberGenerator &rng, unsigned int level) const
		{if (!Validate(rng, level)) {
			splog(SPERR,"crptlib.ThrowIfInvalid","CryptoMaterial: this object contains invalid values");
...
//	virtual std::vector<std::string> GetSupportedFormats(bool includeSaveOnly=false, bool includeLoadOnly=false);
	...
	virtual void Save(BufferedTransformation &bt) const
		{
			splog(SPERR,"crptlib.Save","CryptoMaterial: this object does not support saving");
	...
	virtual void Load(BufferedTransformation &bt)
		{
			splog(SPERR,"crptlib.Load","CryptoMaterial: this object does not support loading");
	...
	virtual void Precompute(unsigned int n)
		...
		assert(!SupportsPrecomputation());
			splog(SPERR,"crptlib.Precompute","CryptoMaterial: this object does not support precomputation");
	...
	virtual void LoadPrecomputation(BufferedTransformation &storedPrecomputation)
		{
		assert(!SupportsPrecomputation());
			splog(SPERR,"crptlib.LoadPrecomputation","CryptoMaterial: this object does not support precomputation");
			//throw NotImplemented("CryptoMaterial: this object does not support precomputation");
		}
	...
	virtual void SavePrecomputation(BufferedTransformation &storedPrecomputation) const
		{
		assert(!SupportsPrecomputation());
			splog(SPERR,"crptlib.SavePrecomputation","CryptoMaterial: this object does not support precomputation");
			//throw NotImplemented("CryptoMaterial: this object does not support precomputation");
		}
...
public:
	...
	virtual void GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &params = g_nullNameValuePairs)
		{
			splog(SPERR,"crptlib.GenerateRandom","GeneratableCryptoMaterial: this object does not support key/parameter generation");
...
public:
	...
	unsigned int DigestSize() const
		{
		splog(SPERR,"crptlib.DigestSize","PK_MessageAccumulator: DigestSize() should not be called");
		//throw NotImplemented("PK_MessageAccumulator: DigestSize() should not be called");
		}
	//! should not be called on PK_MessageAccumulator
	void TruncatedFinal(byte *digest, size_t digestSize) 
		{
		splog(SPERR,"crptlib.TruncatedFinal","PK_MessageAccumulator: TruncatedFinal() should not be called");
